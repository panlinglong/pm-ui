...
<!--&lt;!&ndash;                @click.native.prevent="showChuzu(scope.row,scope.$index)"&ndash;&gt;-->
<!--&lt;!&ndash;                type="text"&ndash;&gt;-->
<!--&lt;!&ndash;                size="small">&ndash;&gt;-->
<!--&lt;!&ndash;                编辑&ndash;&gt;-->
<!--&lt;!&ndash;              </el-button>&ndash;&gt;-->
<!--&lt;!&ndash;              <el-button&ndash;&gt;-->
<!--&lt;!&ndash;                @click.native.prevent="deleteChuzu(scope.row,scope.$index)"&ndash;&gt;-->
<!--&lt;!&ndash;                type="text"&ndash;&gt;-->
<!--&lt;!&ndash;                size="small">&ndash;&gt;-->
<!--&lt;!&ndash;                删除&ndash;&gt;-->
<!--&lt;!&ndash;              </el-button>&ndash;&gt;-->
        ...
        <div>
          <el-form :model="chuzu" :rules="rules" ref="chuzuForm">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="是否满2：" prop="fangs">
